...
\midrule
Measured-difficulty & \na{} & \na{} & \na{} & \na{} & \na{} \\
Uniform-interleaved & 97.0 & 96.0 & 85.5 & 70.5 & 87.25 \\
Inverted weights & \na{} & \na{} & \na{} & \na{} & \na{} \\
No floor ($\rho{=}0$) & \na{} & \na{} & \na{} & \na{} & \na{} \\
\bottomrule
\end{tabular}
\caption{\textbf{Ablations} (SR \%, $40$k budget, all same-machine). The \emph{uniform-interleaved} control (our two-level sampler with flat weights) decomposes the headline gain: it already reaches $87.25$, so the bulk of the improvement over naive uniform ($61.9$) comes from the sampler's fine-grained batch decorrelation rather than from the difficulty weights. The transition-density weighting itself adds a further $+2.5$ on average (uniform-interleaved $87.25$ vs.\ \tds{} $89.75$), concentrated on the up-weighted \textsc{Goal} suite ($+6.5$). \textbf{[TODO: measured-difficulty / inverted / no-floor rows; $\ge 2$ seeds to tighten the $+2.5$, which is near the $20$-trial noise floor.]}}
\label{tab:ablation}
\end{table}
